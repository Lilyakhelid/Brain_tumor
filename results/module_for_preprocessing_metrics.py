...
from PIL import Image
import shutil
from module_for_preprocessing_metrics import load_saved_model
...
def get_k_good(model, k, dir):
    ...
    Args:
        model (keras.Model): Modèle entraîné pour la prédiction.
        k (int): Nombre d'échantillons correctement classés à retourner.

    Returns:
        tuple: X_good, Y_good (tableaux NumPy contenant les images et leurs étiquettes).
    """
