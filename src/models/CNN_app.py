...
pictures_dir = os.path.join(
    os.getcwd(), "pictures"
)  # Chemin vers le répertoire "pictures"
...
samples_dir = os.path.join(
    os.getcwd(), "samples"
)  # Répertoire au même niveau que le fichier
sample_images = [
...
cols = st.columns(4)  # Créer 4 colonnes pour afficher les images côte à côte
...
for i, image_path in enumerate(sample_images):
    if os.path.exists(image_path):
        ...
        with cols[i % 4]:  # Répartir les images sur 4 colonnes
